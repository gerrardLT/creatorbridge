...
import RelatedIPs from '@/components/RelatedIPs';
      ...
      <div className="relative z-30 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20">
        ...
        <div className="grid lg:grid-cols-12 gap-12">
          <div className="lg:col-span-7 space-y-8 animate-fadeInUp">
            <div className="rounded-3xl overflow-hidden border border-white/10 shadow-2xl relative group bg-zinc-900">
              ...
              <div className="absolute top-4 right-4 flex space-x-2">
                <button
                  ...
                  className="p-3 bg-black/50 backdrop-blur-md rounded-full text-white border border-white/10 hover:bg-white hover:text-black transition-colors"
                >
                  <Share2 size={18} />
                </button>
              </div>
            ...
            {/* Related IPs */}
            <RelatedIPs ipId={asset.id} currentCreatorId={asset.creator.id} />
          ...
          <div className="lg:col-span-5 space-y-8 animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="relative group">
              <div className={`absolute -inset-1 bg-gradient-to-r ${isNonCommercial ? 'from-emerald-500 to-teal-500' :
              ...
              <div className="relative bg-zinc-900/80 backdrop-blur-xl border border-white/10 rounded-xl overflow-hidden">
                <div className="bg-white/5 border-b border-white/5 p-6 flex justify-between items-center">
                  ...
                  <Zap className={`${isNonCommercial ? 'text-emerald-400' :
                ...
                <div className="p-8 space-y-6">
                  ...
                  <div className="flex items-end justify-between">
                    <div className="flex flex-col">
                      ...
                      <span className={`text-4xl font-bold tracking-tight ${isNonCommercial ? 'text-emerald-400' : 'text-white'
                        }`}>
