...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white overflow-x-hidden selection:bg-indigo-500/30 selection:text-indigo-200">
      ...
      <div className="relative z-10 pt-32 pb-20 page-reveal">
        {/* Hero Section */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center mb-16 stagger-children">
